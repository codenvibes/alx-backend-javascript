...
button.addEventListener('click', function() {
  console.log(this); // This will likely log the button element
});

button.addEventListener('click', () => {
  console.log(this); // This will likely log the window object, because the arrow function inherits it from the surrounding context. 
});
```
